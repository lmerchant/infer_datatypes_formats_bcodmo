...
#     if len(found_possible_fill_values) and not len(minus_9s) and not len(string_values):
...
#         alt_fill_value = None
#     elif (
#         len(minus_9s) and not len(found_possible_fill_values) and not len(string_values)
#     ):
...
#         alt_fill_value = None
#     elif (
#         len(string_values) and not len(minus_9s) and not len(found_possible_fill_values)
#     ):
#         fill_value = None
...
#         col_found_fill_value = found_params_fill_value[col_name]
#         col_found_alt_fill_value = found_params_alt_fill_value[col_name]
